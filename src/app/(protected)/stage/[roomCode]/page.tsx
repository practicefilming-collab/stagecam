...
function getIdentityIcon(platform: PublicIdentityPlatform | null) {
  switch (platform) {
    case 'instagram':
      return (
        <svg viewBox="0 0 24 24" aria-hidden="true" className="h-3.5 w-3.5" style={{ color: 'var(--instagram)' }}>
    ...
    case 'tiktok':
      return (
        <svg viewBox="0 0 24 24" aria-hidden="true" className="h-3.5 w-3.5" style={{ color: 'var(--tiktok-teal)' }}>
          <path
    ...
    default:
      return (
        <svg viewBox="0 0 24 24" aria-hidden="true" className="h-3.5 w-3.5" style={{ color: 'var(--muted)' }}>
          <path
